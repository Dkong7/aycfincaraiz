...
export default function LocalDetailView({ specs, description, adminFee, priceCop, priceUsd, stratum, neighborhood, municipality }: any) {
    ...
    <div className="space-y-12 animate-in slide-in-from-bottom-4 duration-700 font-sans">
       ...
       <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
             ...
             <MainStat label="Vitrina / Frente" val={`${specs.front || 0} m`} icon={Eye} />
