...
import { faBars, faTimes, faChevronDown, faGlobe, faGavel, faCamera, faChartLine, faPhone, faHome, faBuilding } from "@fortawesome/free-solid-svg-icons";
...
const Navbar = () => {
  ...
  return (
    <header className="relative z-50 font-sans w-full">
      ...
      <div className="bg-white shadow-md relative z-30 px-4 py-2 w-full">
        <div className="max-w-7xl mx-auto flex justify-between items-center h-16 md:h-20">
            ...
            <div className="lg:hidden flex items-center gap-3">
               <button onClick={toggleLang} className="text-xs font-bold border border-slate-200 px-2 py-1 rounded-full text-slate-600">
                  {lang}
               </button>
      ...
      {/* PESTAÑA CURVA (SOLO VISIBLE EN PANTALLAS GRANDES) */}
      ...
      {/* MENÚ MÓVIL FULLSCREEN (Arreglado) */}
