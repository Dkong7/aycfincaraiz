...
import { useLanguage } from "../context/LanguageContext"; // Usamos el contexto real
...
const About = () => {
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      {/* HEADER - SLATE-800 */}
      <div className="relative bg-slate-800 text-white py-24 text-center overflow-hidden pt-32">
        ...
        <div className="relative z-10 container mx-auto px-6 animate-fade-in-up">
          ...
          <div className="inline-block mb-10 transform hover:scale-105 transition duration-500">
             <img src="/ayclogo.svg" alt="A&C Finca Raíz" className="h-40 w-auto object-contain drop-shadow-2xl brightness-0 invert" />
          </div>
        ...
        <div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
             ...
             <div className="bg-white p-10 rounded-[3rem] shadow-xl border border-gray-100 text-center hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
                ...
                <p className="text-pink-600 font-bold text-sm uppercase tracking-wider mb-6 bg-pink-50 inline-block px-4 py-1 rounded-full">{t.about.founderRole1}</p>
             ...
             <div className="bg-white p-10 rounded-[3rem] shadow-xl border border-gray-100 text-center hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
                ...
                <p className="text-blue-900 font-bold text-sm uppercase tracking-wider mb-6 bg-blue-50 inline-block px-4 py-1 rounded-full">{t.about.founderRole2}</p>
                <p className="text-gray-600 leading-relaxed mb-8">
