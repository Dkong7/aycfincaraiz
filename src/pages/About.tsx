import React from "react"; // Eliminamos useState/useEffect si no se usan
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 mt-16 lg:mt-24 space-y-24 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
           <div className="order-2 lg:order-1 animate-fade-in-right">
              <div className="flex items-center gap-4 mb-6">
                 ...
                 <span className="font-bold uppercase tracking-widest text-[#0A192F]">{t('about_story_title')}</span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-8 text-center border-t border-gray-100 pt-8">
                 <div>
                    ...
                    <p className="text-sm text-gray-500 uppercase font-bold">{t('about_stats_clients')}</p>
                 </div>
                 <div>
                    <p className="text-4xl font-bold text-[#0A192F] mb-2">15</p>
                    <p className="text-sm text-gray-500 uppercase font-bold">{t('about_stats_exp')}</p>
                 </div>
                 <div>
                    <p className="text-4xl font-bold text-[#0A192F] mb-2">$80MM+</p>
                    <p className="text-sm text-gray-500 uppercase font-bold">{t('about_stats_sales')}</p>
                 </div>
              </div>
           </div>
        ...
        <div className="bg-slate-50 p-12 rounded-[3rem]">
            <div className="text-center mb-12">
               <h2 className="text-3xl font-bold text-[#0A192F]">{t('about_values_title')}</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all hover:-translate-y-1 text-center">
                  ...
                  <h3 className="font-bold text-xl mb-2 text-[#0A192F]">{t('val1_title')}</h3>
                  <p className="text-gray-500 text-sm">{t('val1_desc')}</p>
               </div>
               <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all hover:-translate-y-1 text-center">
                  <FontAwesomeIcon icon={faChartLine} className="text-4xl text-blue-500 mb-4" />
                  <h3 className="font-bold text-xl mb-2 text-[#0A192F]">{t('val2_title')}</h3>
                  <p className="text-gray-500 text-sm">{t('val2_desc')}</p>
               </div>
               <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all hover:-translate-y-1 text-center">
                  <FontAwesomeIcon icon={faHeart} className="text-4xl text-pink-500 mb-4" />
                  <h3 className="font-bold text-xl mb-2 text-[#0A192F]">{t('val3_title')}</h3>
                  <p className="text-gray-500 text-sm">{t('val3_desc')}</p>
               </div>
            </div>
        </div>
        ...
        <div>
           <div className="text-center mb-16 animate-fade-in-up">
              <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">{t('about_team_title')}</h2>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
             ...
             <div className="bg-white p-10 rounded-[3rem] shadow-xl border border-gray-100 text-center hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group relative overflow-hidden">
                ...
                <p className="text-pink-600 font-bold text-xs uppercase tracking-widest mb-6">{t('role_founder1')}</p>
             ...
             <div className="bg-white p-10 rounded-[3rem] shadow-xl border border-gray-100 text-center hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group relative overflow-hidden">
                ...
                <p className="text-blue-900 font-bold text-xs uppercase tracking-widest mb-6">{t('role_founder2')}</p>
                <p className="text-gray-600 leading-relaxed mb-8">
                  {t('desc_founder2')}
                </p>
                <SocialLinks linkedin="https://linkedin.com" instagram="https://instagram.com" />
