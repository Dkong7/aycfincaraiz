...
const AdminDashboard = () => {
  ...
  // Extraer datos del usuario activo
    ...
    <div className="bg-slate-50 min-h-screen p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-slate-500 mb-12 flex items-center gap-2">
           Bienvenid{title === "Maestra" ? "a" : "o"}, <span className="font-bold text-blue-900">{title} {name}</span>. ¿Qué desea gestionar hoy?
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
           <Link to="/admin/crear" className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all border-b-4 border-blue-500 group">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 text-3xl mb-6 group-hover:bg-blue-600 group-hover:text-white transition-colors"><FontAwesomeIcon icon={faPlus} /></div>
           ...
           <Link to="/admin/inmuebles" className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all border-b-4 border-green-500 group">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center text-green-600 text-3xl mb-6 group-hover:bg-green-600 group-hover:text-white transition-colors"><FontAwesomeIcon icon={faList} /></div>
           ...
           <Link to="/admin/blog" className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all border-b-4 border-purple-500 group">
              <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center text-purple-600 text-3xl mb-6 group-hover:bg-purple-600 group-hover:text-white transition-colors"><FontAwesomeIcon icon={faNewspaper} /></div>
           ...
           <Link to="/admin/asesores" className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all border-b-4 border-yellow-500 group">
              <div className="w-16 h-16 bg-yellow-100 rounded-full flex items-center justify-center text-yellow-600 text-3xl mb-6 group-hover:bg-yellow-500 group-hover:text-white transition-colors"><FontAwesomeIcon icon={faUsersCog} /></div>
              <h3 className="text-xl font-bold text-slate-800">Maestros</h3>
              <p className="text-sm text-slate-400 mt-2">Perfiles y accesos.</p>
           </Link>
        </div>
      </div>
    </div>
